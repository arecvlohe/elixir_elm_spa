...
var _user$project$Main$view = function (model) {
	return _elm_lang$html$Html$text(
		A2(_elm_lang$core$Basics_ops['++'], 'Hello, ', model.hello));
};
...
var _user$project$Main$decode = A2(_elm_lang$core$Json_Decode$field, 'hello', _elm_lang$core$Json_Decode$string);
...
var _user$project$Main$Model = F2(
	function (a, b) {
		return {history: a, hello: b};
	});
var _user$project$Main$Hello = function (a) {
	return {ctor: 'Hello', _0: a};
};
var _user$project$Main$getHello = A2(
	_elm_lang$http$Http$send,
	_user$project$Main$Hello,
	A2(_elm_lang$http$Http$get, '/api/hello', _user$project$Main$decode));
var _user$project$Main$init = function (location) {
	return {
		...
		_0: A2(
			...
			''),
		_1: _elm_lang$core$Native_Utils.eq(location.pathname, '/hello') ? _user$project$Main$getHello : _elm_lang$core$Platform_Cmd$none
	};
};
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Main.Msg":{"args":[],"tags":{"Hello":["Result.Result Http.Error String"],"UrlChange":["Navigation.Location"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
